...
> **Один факт — одно canonical место. Обычный batch — 1–3 связанные задачи, но завершение фазы определяют проверенные acceptance criteria. Один вопрос — сначала один подходящий tool.**
